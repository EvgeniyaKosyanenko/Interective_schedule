 ...
 * @author Slava
 */
public class window_check_class extends JFrame{
    static int i = 0;
 
    public window_check_class() throws SQLException {
      ...
      /*  for (int i = 0; i < 30; i++) {
        ...
        ResultSet rs = s.executeQuery("select * from CHECK_CLASSROOMS");
        ...
        TableModel model = new Information_about_classrooms_checks_table(beans);
